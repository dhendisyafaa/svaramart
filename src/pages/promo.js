...
const promo = () => {
  return (
    <div className='h-[2000px] bg-navy'>
      ...
      <div className='mt-12 bg-white lg:px-24'>
        <div className='max-w-[1000px] mx-12 h-24 relative -top-9 rounded-lg bg-white shadow-md flex justify-around items-center'>
