...
const detail = () => {
  return (
    <div className='h-[2000px]'>
      <div className='bg-navy px-3 py-4 flex items-center justify-end w-full'>
        <BagIcon color="#fff" />
        <HamburgerMenu />
      </div>
      <div className='lg:px-20 lg:mt-12'>
          ...
          <div className=''>
            <div className='px-3 py-3'>
              ...
              <div className='shadow p-3 rounded-lg mt-3'>
                <p className='text-navy font-semibold'>Variant</p>
      ...
      <div className='hidden fixed bottom-0 w-full py-3 lg:px-12 rounded-t-xl bg-white shadow-[0px_5px_10px_0px_rgba(0,0,0,1)] z-30 lg:flex justify-between'>
        ...
        <div className='flex gap-3 items-center justify-around'>
          ...
          <div>
            <p className='text-grey text-xs font-medium'>Total Harga</p>
            <p className='text-navy font-bold'>Rp. 12000</p>
          </div>
          <div className='flex gap-2'>
      ...
      {/* nav mobile */}
      <div className='lg:hidden flex fixed bottom-0 items-center w-full py-5 px-2 gap-1 justify-around sm:justify-end rounded-t-xl bg-white shadow-[0px_5px_10px_0px_rgba(0,0,0,1)] z-30'>
        <div className='border border-navy px-3 py-1 rounded-lg'>
          <ChatIcon color='#1F3C42' />
        </div>
        <button type="" className='border border-navy rounded-lg text-navy px-6 py-1'>Beli Sekarang</button>
